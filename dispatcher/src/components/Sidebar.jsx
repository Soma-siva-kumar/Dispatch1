...
import { Map, AlertTriangle, Shield, BarChart2, LogOut, Bell } from 'lucide-react';
  ...
  return (
    <aside className="sidebar">
      <Link to="/" className="sidebar-logo" style={{ borderBottom: '1px solid var(--border)', textDecoration: 'none', cursor: 'pointer' }}>
        ...
        <div>
          <div className="logo-text">Dispatcher</div>
      ...
      <div className="sidebar-footer">
        ...
        <div className="user-card" onClick={() => { logout(); navigate('/login'); }}>
          <div className="user-avatar" style={{ background: 'linear-gradient(135deg, var(--accent-blue), #3051d3)' }}>
