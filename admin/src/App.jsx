  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        {/* Admin Routes */}
        <Route path="/control-room" element={<ProtectedRoute allowedRoles={['admin']}><ControlRoom /></ProtectedRoute>} />
        <Route path="/incidents" element={<ProtectedRoute allowedRoles={['admin']}><Incidents /></ProtectedRoute>} />
